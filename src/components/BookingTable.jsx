...
const TableRow = ({ booking, removeBookingHandler }) => {
  const { bookingId, from, to, date, guests, ticketClass } = booking;
      ...
      <td className="px-6 py-4 text-center">
        <div className="flex justify-center gap-4">
          <button
            ...
            onClick={() => removeBookingHandler(bookingId)}
          >
            <svg
...
const TableBody = ({ bookings }) => {
  ...
  const removeBookingHandler = (bookingId) => {
